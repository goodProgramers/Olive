						...
						<div class="tbl_cont_area">		
								...
								<div class="tbl_cell w390">
									<div class="prd_info ">
										<a class="prd_img" href="javascript:common.link.moveGoodsDetail('A000000156060','');">	
											<img data-original="${cartList.prm_url}" class="completed-seq-lazyload" alt="상품이미지" src="${cartList.prm_url}">
										</a>
										<a class="prd_name">
											<span class="tx_sale_info"></span><!-- 브랜드명 및 할인정보 -->
											<span id="brandNm">${cartList.br_name}</span>
											<p id="goodsNm">${cartList.pr_name}</p>
										</a>
										<p class="prd_opt"></p>
										<p class="prd_flag">
								...
								<div class="tbl_cell w110">
									<span class="cur_price" value="129000">
										<span class="tx_num">${cartList.prpri_price}</span>원
									</span>
								</div>
