	...
	<div id="Header">
		...
		<div class="top_util">
			<ul class="menu_list" id="menu_list_header">
				...
				<li class="cart"><a href="<%= request.getContextPath() %>/olive/cart.do" data-attr="공통^헤더^장바구니">장바구니<span id="cartToCnt"></span></a></li>
		...
		<div class="header_inner">
			<h1><a href="#"><img src="/image/logo.png" alt="올리브영"></a></h1>
